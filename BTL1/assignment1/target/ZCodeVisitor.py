...
class ZCodeVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by ZCodeParser#dclr_list.
    def visitDclr_list(self, ctx:ZCodeParser.Dclr_listContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by ZCodeParser#elmt_prime.
    def visitElmt_prime(self, ctx:ZCodeParser.Elmt_primeContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by ZCodeParser#elmt.
    ...
    # Visit a parse tree produced by ZCodeParser#arr_prime.
    ...
    # Visit a parse tree produced by ZCodeParser#str_oprnd.
    def visitStr_oprnd(self, ctx:ZCodeParser.Str_oprndContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by ZCodeParser#arr_assgn.
    def visitArr_assgn(self, ctx:ZCodeParser.Arr_assgnContext):
        return self.visitChildren(ctx)
